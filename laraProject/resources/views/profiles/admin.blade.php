...
@section('content')
        ...
        <div class="mega_container">
            ...
            <div class="page">
                ...
                <h3>Clicca <a href="{{ route('elimina-utente') }}">qui</a> per eliminare gli utenti</h3>
                <h3>Clicca <a href="{{ route('gestisci-staff') }}">qui</a> per gestire i membri dello staff</h3>
                <h3>Statistiche:</h3>
